 ...
 * Description: Automated affiliate payouts for WooCommerce using Bitcoin Lightning Network and BTCPayServer (Compatible with BTCPay Server 1.x and 2.0)
 * Version: 0.2.0
 * Author: BtcPins
    ...
    class Pulse {
        ...
        public function process_affiliate_payout($order_id) {
			...
			if (isset($custom_mappings[$encoded_affiliate])) {
				...
				// Not a custom mapping, try to decode it
